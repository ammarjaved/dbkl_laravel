            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('application.edit',$permit->application_id)}}">Permit</a></li>
    ...
    <div class="card p-4">
        ...
        <div class="row pb-3">
            <button class="btn d-flex justify-content-between " type="button" data-bs-toggle="collapse"
                data-bs-target="#collapseA" aria-expanded="false" aria-controls="collapseA" id="section_a"
                onclick="changeIcon('section_a_icon')">
                            ...
                            <tbody>
                                @foreach ($data['geom'] as $map)
                                    <tr>
                                        ...
                                        <td>
                                            <select name="section_b[select]" class="form-select"
                                                id="kaedah_{{ $loop->index }}" onchange="kaedah({{ $loop->index }})">
                                                <option value="{{ $permit->section_b->select }}" hidden>
                                                    {{ $permit->section_b->select }}</option>
                                                <option value="KT">KT</option>
                                                <option value="HDD/PJ/MT/PT">HDD/PJ/MT/PT</option>

                                                <option value="BH">BH</option>
                                            </select>
                                            <input type="hidden" name="section_b[value]"
                                                value="{{ $permit->section_b->value }}" id="section_b_value">
                                        </td>
                                        <td id="sel_kaedah_{{ $loop->index }}" class="text-center">
                                            {{ $permit->section_b->value }} </td>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>HDD/PJ/MT/PT</td>
                                    <td>‘Horizontal Directional Drilling’(HDD), ‘Pipe Jacking’(PJ), ‘Micro Trenching’ (MT)
                                        Dan
                        ...
                        <table class="table table-bordered ">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>pit</td>
                                    <td><input type="number" class="form-control" name="lorong[key_1]" id="section_c_1"
                                            onchange="logong('section_c',1)" value="{{ $permit->section_c->key_1 }}"> </td>
                                ...
                                <tr>
                                    ...
                                    <td>Stone Mastic Asphalt or Equivalent + Tack Coat (Rs-2k)+ Milling Works + Road
                                        Marking Works (as per specification)</td>
                                    <td>pit </td>
                                    <td><input type="number" class="form-control" name="lorong[key_2]" id="section_c_2"
                                            onchange="logong('section_c',2)" value="{{ $permit->section_c->key_2 }}"></td>
                                ...
                                <tr>
                                    ...
                                    <td>m2</td>
                                    <td><input type="number" class="form-control" name="lorong[key_3]" id="section_c_3"
                                            onchange="logong('section_c',3)" value="{{ $permit->section_c->key_3 }}">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>nos</td>
                                    <td><input type="number" class="form-control" name="lorong[key_4]" id="section_c_4"
                                            onchange="logong('section_c',4)" value="{{ $permit->section_c->key_4 }}">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>nos</td>
                                    <td><input type="number" class="form-control" name="lorong[key_5]" id="section_c_5"
                                            onchange="logong('section_c',5)" value="{{ $permit->section_c->key_5 }}">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>Turfing</td>
                                    <td>m2</td>
                                    <td><input type="number" class="form-control" name="lorong[key_6]" id="section_c_6"
                                            onchange="logong('section_c',6)" value="{{ $permit->section_c->key_6 }}">
                                    </td>
        ...
        <div class="row pb-3">
            <button class="btn d-flex justify-content-between" type="button" data-bs-toggle="collapse"
                ...
                <span> BAHAGIAN D: KADAR CAJ BAIK PULIH JALAN ( KOREKAN TERBUKA DAN MICRO TRENCHING)</span><i
                    class="fas fa-plus" id="section_d_icon"></i>
            </button>
                        ...
                        <table class="table table-bordered table-responsive">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>m</td>
                                    <td><input type="number" class="form-control" name="BILlorong[key_1]"
                                            id="section_d_1" onchange="logong('section_d',1)"
                                ...
                                <tr>
                                    ...
                                    <td>Stone Mastic Asphalt or Equivalent + Tack Coat (Rs-2k)+ Milling Works + Road Marking
                                        Works (as per specification)</td>
                                    <td>m</td>
                                    <td><input type="number" class="form-control" name="BILlorong[key_2]"
                                            id="section_d_2" onchange="logong('section_d',2)"
                                ...
                                <tr>
                                    ...
                                    <td>Footpath with finishing Interlocking Concrete Paving / Clay Paver / Granite Tiled &
                                        Miscellaneous</td>
                                    <td>m2</td>
                                    <td><input type="number" class="form-control" name="BILlorong[key_3]"
                                            id="section_d_3" onchange="logong('section_d',3)"
                                ...
                                <tr>
                                    ...
                                    <td>Ujian Loose Sample & Marshall Test
                                        ...
                                        kerja pengorekan)</td>
                                    <td>nos</td>
                                    <td><input type="number" class="form-control" name="BILlorong[key_4]"
                                            id="section_d_4" onchange="logong('section_d',4)"
                                ...
                                <tr>
                                    ...
                                    <td>nos</td>
                                    <td><input type="number" class="form-control" name="BILlorong[key_5]"
                                            id="section_d_5" onchange="logong('section_d',5)"
                                ...
                                <tr>
                                    ...
                                    <td>Turfing</td>
                                    <td>m2</td>
                                    <td><input type="number" class="form-control" name="BILlorong[key_6]"
                                            id="section_d_6" onchange="logong('section_d',6)"
                                ...
                                <tr>
                                    ...
                                    <td><input type="hidden" name="total_section_d"><span
                                            id="total_section_d">{{ $permit->total_section_d }}</span></td>
